...
(defun simplify-expr2 (e) ;; normalize -> simplify -> denormalize
  (with-templates (((diff @ $) => 0)
                   ...
                   ((diff (expt $1 $2) _3) => `(diff (exp (* ,$2 (log ,$1))) ,_3))
                   ((diff (log $1) _2) => `(/ (diff ,$1 ,_2) ,$1))
                   ((diff (sin $1) _2) => `(* (cos ,$1) (diff ,$1 ,_2)))
                   ((diff (cos $1) _2) => `(* -1 (sin ,$1) (diff ,$1 ,_2)))
                   ((diff (tan $1) _2) => `(/ (diff ,$1 ,_2) (expt (cos ,$1) 2)))
                   ((diff (ctan $1) _2) => `(* -1 (/ (diff ,$1 ,_2) (expt (sin ,$1) 2))))
                   ((diff (asin $1) _2) => `(/ (diff ,$1 ,_2) (sqrt (- 1 (expt $1 2)))))
                   ((diff (acos $1) _2) => `(* -1 (/ (diff ,$1 ,_2) (sqrt (- 1 (expt $1 2))))))
                   ((diff (atan $1) _2) => `(/ (diff ,$1 ,_2) (+ 1 (expt $1 2))))
                   ((diff (actan $1) _2) => `(* -1 (/ (diff ,$1 ,_2) (+ 1 (expt $1 2))))))
